...
<head>
    ...
    <style>
        ...
        .otp-code { font-size: 32px; font-weight: 800; letter-spacing: 6px; color: #438EB9; background-color: #E8F2F8; padding: 16px 24px; border-radius: 6px; display: inline-block; margin: 20px 0; border: 1px dashed #438EB9; }
...
<body>
    <div class="email-card">
        ...
        <div class="email-body">
            <p style="font-size: 15px; margin-bottom: 8px;"><?= lang('Auth.email2FAMailBody') ?></p>
            <div class="otp-code"><?= esc($code) ?></div>
            <p style="font-size: 13px; color: #636E72;">This verification code will expire shortly. Do not share this code with anyone.</p>
        </div>
