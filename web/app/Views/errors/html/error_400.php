...
<head>
    ...
    <style>
        ...
        .error-code { font-size: 7rem; font-weight: 800; line-height: 1; margin-bottom: 0.25rem; background: linear-gradient(135deg, var(--primary) 0%, #4834D4 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
...
<body>
    <div class="error-card">
        <div class="illustration"><i class="fa-solid fa-circle-exclamation"></i></div>
        <div class="error-code">400</div>
        <h1 class="error-title">Bad Request</h1>
        <p class="error-message">The server could not understand your request. Please check your parameters and try again.</p>
        <div class="d-grid gap-2">
            <a href="/" class="btn btn-primary btn-lg"><i class="fa-solid fa-house me-2"></i>Return Home</a>
            <button onclick="window.history.back()" class="btn btn-link text-decoration-none text-secondary"><i class="fa-solid fa-arrow-left me-1"></i>Go Back</button>
        </div>
    </div>
</body>
</html>
