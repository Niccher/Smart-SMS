...
<head>
    ...
    <style>
        ...
        .error-code { font-size: 7rem; font-weight: 800; line-height: 1; margin-bottom: 0.25rem; background: linear-gradient(135deg, #FF4757 0%, #E84118 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
        ...
        .illustration { font-size: 4rem; color: #FF4757; margin-bottom: 0.75rem; }
...
<body>
    <div class="error-card">
        ...
        <div class="d-grid gap-2">
            <a href="/login" class="btn btn-primary btn-lg"><i class="fa-solid fa-arrow-right-to-bracket me-2"></i>Login to Continue</a>
