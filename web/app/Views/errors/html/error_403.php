...
<body>
    <div class="error-card">
        <div class="illustration"><i class="fa-solid fa-hand"></i></div>
        <div class="error-code">403</div>
        <h1 class="error-title">Access Forbidden</h1>
        <p class="error-message">You don't have permission to access this resource. Contact the administrator if you believe this is a mistake.</p>
        <div class="d-grid gap-2">
            <a href="/" class="btn btn-primary btn-lg"><i class="fa-solid fa-house me-2"></i>Back to Safety</a>
