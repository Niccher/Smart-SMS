...
<!-- Reusable Ace Footer Component -->
<footer class="ace-footer">
    <div class="small text-muted">
        &copy; <?= date('Y') ?> <strong class="text-primary">Mpesa Analyzer Platform</strong>. All rights reserved.
    </div>
    <div class="d-flex flex-wrap gap-2 gap-sm-3 align-items-center">
        <!-- Interactive Version Changelog Trigger -->
        <a href="#" data-bs-toggle="modal" data-bs-target="#changelogModal" class="badge bg-primary bg-opacity-10 text-primary border border-primary-subtle text-decoration-none px-2.5 py-1.5 shadow-xs" title="Click to view v<?= esc($systemVersion) ?> release notes & changelog">
            <i class="fa-solid fa-code-branch me-1"></i>v<?= esc($systemVersion) ?>
            <span class="d-none d-sm-inline fw-normal ms-1 opacity-75">Changelog</span>
        </a>

        <a href="#" data-bs-toggle="modal" data-bs-target="#docsModal" class="text-decoration-none text-muted small">
            <i class="fa-solid fa-book-open me-1 text-info"></i> Docs
        </a>
        <a href="<?= esc($systemGithub) ?>" target="_blank" class="text-decoration-none text-muted small" title="Monorepo GitHub">
            <i class="fa-brands fa-github me-1"></i> Web & ML
        </a>
        <a href="<?= esc($systemAndroidGithub) ?>" target="_blank" class="text-decoration-none text-muted small" title="Android Companion App GitHub">
            <i class="fa-brands fa-android me-1 text-success"></i> App
        </a>
    </div>
</footer>
